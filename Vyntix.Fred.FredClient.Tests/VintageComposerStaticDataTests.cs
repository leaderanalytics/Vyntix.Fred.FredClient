...
public class VintageComposerStaticDataTests
{
    ...
    private List<FredVintage> CreateTestData()
    {
        ...
        v2.Observations.Add(new FredObservation { VintageDate = v2.VintageDate, Vintage = v2, ObsDate = new DateTime(1999, 2, 2), Value = "2.2" }); //Missing in Vintage 1
        v2.Observations.Add(new FredObservation { VintageDate = v2.VintageDate, Vintage = v2, ObsDate = new DateTime(1999, 3, 1), Value = "3.5" });
        ...
        v3.Observations.Add(new FredObservation { VintageDate = v3.VintageDate, Vintage = v3, ObsDate = new DateTime(1999, 2, 2), Value = "2.2" }); // must exist here as it cannot be removed
